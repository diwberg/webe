...
import { useCollectionImageMutations } from "../../hooks/use-collection-image"
...
export const CollectionMediaModal = ({
    collectionId,
    existingImages,
            ...
            <FocusModal.Content>
                ...
                <FocusModal.Body className="flex h-full overflow-hidden">
                    ...
                    <CommandBar open={selectedImageIds.size > 0}>
                        <CommandBar.Bar>
                            <CommandBar.Value>
                                {selectedImageIds.size} selecionados
                            </CommandBar.Value>
